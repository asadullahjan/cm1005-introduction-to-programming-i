function drawGameChar() {
  ...
  if (isLeft && isFalling) {
    ...
    stroke(1);
    line(
      gameChar_screen_x - 10,
      gameChar_screen_y - 5,
      gameChar_screen_x - 5,
      gameChar_screen_y - 18
    ); //leg
    line(
      gameChar_screen_x + 3,
      gameChar_screen_y - 18,
    ...
    line(
      gameChar_screen_x - 5,
      gameChar_screen_y - 35,
      gameChar_screen_x - 20,
      gameChar_screen_y - 45
    ); //arm
    line(
      gameChar_screen_x + 20,
      gameChar_screen_y - 25,
      gameChar_screen_x + 8,
      gameChar_screen_y - 35
    ); //arm
    strokeWeight(1);
    ...
    line(
      gameChar_screen_x + 10,
      gameChar_screen_y - 33,
      gameChar_screen_x + 23,
      gameChar_screen_y - 25
    ); //arm
    line(
      gameChar_screen_x - 23,
    ...
    line(
      ...
      gameChar_screen_y - 35,
      gameChar_screen_x + 23,
      gameChar_screen_y - 50
    );
    line(
      gameChar_screen_x - 23,
      gameChar_screen_y - 50,
      gameChar_screen_x - 11,
      gameChar_screen_y - 35
    );
    strokeWeight(1);
  } else {
