...
function setup() {
	...
	trees = [
		...
		{
			posX: treesAnchorX + random(150,300),
			size: random(100,125)
		},
		{
			posX: treesAnchorX + random(450,550),
			size: random(100,125)
		},
		{
			posX: treesAnchorX + random(650,843),
			size: random(100,125)
		},
		{
			posX: treesAnchorX + random(1000,1208),
			size: random(100,125)
		},
		{
			posX: treesAnchorX + random(1300,1408),
			size: random(100,125)
		},
		{
			posX: treesAnchorX + random(1450,1609),
			size: random(100,125)
		},
		{
			posX: treesAnchorX + random(1780,1890),
			size: random(100,125)
		},
	];
